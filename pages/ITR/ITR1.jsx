      ...
      <Grid container spacing={4} className="mt-[50px] px-8 lg:px-28 xl:px-[250px] mb-20 ">
        <Grid item lg={7} md={6} sm={12}>
          <Box>
            ...
            <p className="text-[45px] mt-4 text-black font-semibold">File ITR 1 in <spam className="text-blue-700">3 minutes</spam></p>
            <Box className="mt-4">
              <Box className="flex mt-2">
                <CheckCircleOutlineIcon className="text-green-600 text-[36px]" />
                <p className="ml-4 text-gray-700 text-[20px] ">Salary (Form-16) Below Rs 50 Lakhs</p>
              </Box>
              <Box className="flex mt-2">
                <CheckCircleOutlineIcon className="text-green-600 text-[36px]" />
