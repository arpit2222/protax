...
export default function ITR1() {
  return (
    <main
      className={`flex bg-white min-h-screen flex-col items-center ${inter.className} bg-gradient-to-r from-[#BBD0F9] via-[#E1E5E5] to-pink-[#BBD0F9]`}
    >
      <Navbar />
      ...
      <Grid container spacing={4} className="mt-[50px] px-8 lg:px-28 xl:px-[250px] mb-20 ">
        <Grid item lg={7} md={6} sm={12}>
          <Box>
            <p className="text-[30px] text-gray-600 font-semibold">Income Tax eFiling (Trust)</p>
            <p className="text-[45px] mt-4 text-black font-semibold">File ITR 7 in <spam className="text-blue-700">3 minutes</spam></p>
            <Box className="mt-4">
              <Box className="flex mt-2">
                <CheckCircleOutlineIcon className="text-green-600 text-[36px]" />
                <p className="ml-4 text-gray-700 text-[20px] "> ITR 7 Form filing is done by the companies who service the income from the properties that are of charitable or religious purposes.</p>
              </Box>
              <Box className="flex mt-2">
                <CheckCircleOutlineIcon className="text-green-600 text-[36px]" />
                <p className="ml-4 text-gray-700 text-[20px]">Properties that are held under the trusts or legal obligation in parts or even wholly are included in the category.</p>
              </Box>
            </Box>
