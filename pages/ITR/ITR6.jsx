    ...
    >
      ...
      <Grid container spacing={4} className="mt-[50px] px-8 lg:px-28 xl:px-[250px] mb-20 ">
        <Grid item lg={7} md={6} sm={12}>
          <Box>
            <p className="text-[30px] text-gray-600 font-semibold">Income Tax eFiling (Companies)</p>
            <p className="text-[45px] mt-4 text-black font-semibold">File ITR 6 in <spam className="text-blue-700">3 minutes</spam></p>
            <Box className="mt-4">
              <Box className="flex mt-2">
                <CheckCircleOutlineIcon className="text-green-600 text-[36px]" />
                <p className="ml-4 text-gray-700 text-[20px] "> ITR 6 Form is to be filed by every company irrespective of its structure registered under the Companies Act 2013 or the earlier Companies Act 1956</p>
              </Box>
              <Box className="flex mt-2">
                <CheckCircleOutlineIcon className="text-green-600 text-[36px]" />
                <p className="ml-4 text-gray-700 text-[20px]"> However, the companies whose source of income comes from the property that is held for religious or charitable purposes are not required to file ITR 6 Form.</p>
              </Box>
            </Box>
